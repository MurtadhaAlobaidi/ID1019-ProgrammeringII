defmodule Huffman do
    ...
    def text, do: 'MISSISSIPI RIVER'
    #'this is something that we should encode'

    # Run all the steps of Huffman encoding and decoding.
    #To test
    # sample = Huffman.sample()
    # tree = Huffman.tree(sample)
    # encode = Huffman.encode_tuple(tree)
    # decode = Huffman.decode_table(tree)
    # text = Huffman.text()
    # seq = Huffman.encode_tuple(text, encode)
    # Huffman.decode(seq, decode)

    def test do
      sample = sample()
      tree = tree(sample)
      encode = encode_tuple(tree)#shafer
      decode = decode_table(tree)#oppna
      text = text()
